...
Mobile.tap(findTestObject('mb/c/bD'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('mb/c/b1'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('mb/c/bS'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('mb/c/b1'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('mb/c/bM'), GlobalVariable.DEFAULT_TIMEOUT)
