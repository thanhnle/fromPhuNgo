...
WebUI.waitForElementNotPresent(findTestObject('Object Repository/Home/My Account/alert_Update successfully'), GlobalVariable.DEFAULT_TIMEOUT)
...
String expectedGreetings = (CustomKeywords.'general.Methods.greetings'(calendar.get(Calendar.HOUR_OF_DAY).toInteger()) + 
', ') + resetName
